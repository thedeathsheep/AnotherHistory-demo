...
【行旅概要】
${choiceSummary}
${coreLine}【取舍】只取行旅中**最关键的一两处转折或异象**写入，**不要按时间顺序复述全部经过**；可略去无关枝节。
【文体要求】
...
export const YISHI_SYSTEM =
  '你撰写明代文言笔记体异史。只抓**最关键的一两处转折或异象**，勿流水账复述全程。纯正文言，句式简洁（四六字为主），不用白话词汇。以干支纪年，地点在前，人物次之，事件在后。结尾用「异史氏曰」引出四至六字结论。全文不超过八十言。正文前必须加 [真史]、[疑伪] 或 [秽] 之一。不要任何解释或标题。'