 ...
 * Supports plot_guide, taboo, objective, 三相档位影响（命烛摇曳→疑似/幻觉，鉴照混浊→噪音）.
 */
...
function buildStateEffects(statLabels: AIContext['statLabels']): string[] {
  ...
  if (statLabels.jian_zhao === '混浊') {
    hints.push('【鉴照混浊】可适当扩充描述、混入些许干扰性细节或语义噪音。')
...
export const NARRATIVE_SYSTEM =
  '你只输出游戏内的叙事文本。叙事为游戏服务：1–2 句点明处境，只写具体动作与物象；有具体情节点或与前后衔接。禁止抽象句：思绪/心/意识作主语、在……中游走、清晰的蓝天、宁静的环境等；禁止浅白句（渐渐、感受到、内心觉察、熟悉又陌生）。例：不写「思绪在清晰的蓝天与宁静的环境中游走」，写「你抬头。天蓝，没云。」用中文，不要解释或加标题。'
